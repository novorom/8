      ...
      <div className="relative max-w-7xl mx-auto px-6 py-24 lg:py-28 flex items-center min-h-[520px]">
        <div className="max-w-xl">
          ...
          <div className="flex flex-wrap gap-3">
            <Link
              href="/catalog"
              className="px-7 py-3.5 bg-blue-600 text-white rounded-xl shadow-lg shadow-blue-200 hover:bg-blue-700 hover:shadow-xl hover:-translate-y-0.5 transition-all duration-200 font-semibold text-sm"
            >
              Смотреть каталог →
            </Link>
            <Link
