...
const footerLinks = {
  ...
  seo: [
    ...
    { label: "Плитка для ванной", href: "/plitka-dlya-vannoj-spb" },
    { label: "Плитка для кухни", href: "/plitka-dlya-kuhni-spb" },
    { label: "Плитка в Мурино", href: "/murino-spb" },
    { label: "Плитка в Кудрово", href: "/kudrovo-spb" },
    { label: "Плитка Всеволожск", href: "/vsevolozhsk-spb" },
    { label: "Плитка Приморский р-н", href: "/primorskiy-raion-spb" },
    { label: "Керамогранит 60x120", href: "/keramogranit-60x120-spb" },
    { label: "Керамогранит 60x60", href: "/keramogranit-60x60-spb" },
    { label: "Плитка 30x60", href: "/plitka-30x60-spb" },
    { label: "Керамогранит Тераццо", href: "/terracca-spb" },
    { label: "Плитка Пэчворк", href: "/pechvork-spb" },
    { label: "Белый мрамор", href: "/belaya-plitka-pod-mramor-spb" },
    { label: "Серый бетон", href: "/seraya-plitka-pod-beton-spb" },
    { label: "Ступени из керамогранита", href: "/stupeni-iz-keramogranita-spb" },
    { label: "Плитка для гаража", href: "/dlya-garazha-spb" },
