      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({{
            ...
            {
              "@type": "Question",
              name: "Где купить керамогранит 60x120 в СПб?",
              acceptedAnswer: { "@type": "Answer", text: "Керамогранит 60x120 Cersanit есть в наличии на складе в Янино. Самовывоз бесплатно, доставка по СПб от 1 дня. Звоните: +7 (905) 205-09-00." },
            },
            {
              "@type": "Question",
              name: "Подходит ли формат 60x120 для пола?",
              acceptedAnswer: { "@type": "Answer", text: "Да, крупный формат 60x120 отлично подходит для пола — меньше швов и визуально расширяет пространство. Минимальная толщина основания — 5 см бетонной стяжки." },
            },
            {
              "@type": "Question",
              name: "Нужно ли резать плитку 60x120?",
              acceptedAnswer: { "@type": "Answer", text: "Как правило, да. Для этого формата нужен профессиональный плиткорез или болгарка с алмазным диском. Наши менеджеры рассчитают нужный запас бесплатно." },
            }
            ],
          }}),
        }}
