...
const brandData: Record<string, BrandInfo> = {
  ...
  "cersanit": {
    name: "Cersanit",
    brandField: "Cersanit",
    title: "Плитка Cersanit в СПб — купить на складе в СПб | Плитки СПб",
    description: "Cersanit в Санкт-Петербурге: керамогранит, настенная плитка, мозаика. Calacatta, Wood Concept, Lofthouse. склад в СПб, доставка по СПб.",
    ...
    advantages: ["Коллекции Calacatta, Wood Concept", "Польское качество от 626 ₽/м²", "Все форматы: 22×90, 30×60, 60×120", "склад в СПб, доставка от 1 дня"],
  ...
  "nefrit-keramika": {
    ...
    title: "Плитка Нефрит-Керамика в СПб — склад в СПб | Плитки СПб",
    description: "Нефрит-Керамика в Санкт-Петербурге: российский производитель, большой ассортимент на складе в СПб. Самовывоз и доставка по СПб.",
  ...
  "granitea": {
    ...
    description: "Гранитея (Уральский гранит) в Санкт-Петербурге: Allaki, Arkaim, Iremel. Морозостойкий керамогранит. склад в СПб, доставка по СПб.",
  ...
  "idalgo": {
    name: "Идальго",
    brandField: "Идальго",
    title: "Плитка Идальго в СПб — купить на складе в СПб | Плитки СПб",
    description: "Идальго в Санкт-Петербурге: керамогранит и плитка уральского производителя. Коллекции Concepta, Anna, Siena. склад в СПб, доставка по СПб.",
  ...
  "bonapart": {
    name: "Бонапарт",
    brandField: "Бонапарт",
    title: "Плитка Бонапарт в СПб — купить на складе в СПб | Плитки СПб",
    description: "Бонапарт в Санкт-Петербурге: широкий ассортимент керамической плитки на складе в СПб. Самовывоз и доставка по СПб от 1 дня.",
  ...
  "dako": {
    name: "Dako",
    brandField: "Dako",
    title: "Плитка Dako в СПб — купить на складе в СПб | Плитки СПб",
    description: "Dako в Санкт-Петербурге: керамогранит формата 60×60. Коллекции Genio, Harmony, Prime и другие. склад в СПб, доставка по СПб.",
    ...
    advantages: ["Керамогранит 60×60", "Более 15 коллекций", "Доступные цены", "склад в СПб"],
    logoUrl: "https://res.cloudinary.com/de1sotnld/image/upload/v1776174052/brands/dako.jpg",
  },
  "eletto": {
    name: "Элетто",
    brandField: "Элетто",
    title: "Плитка Eletto в СПб — купить на складе в СПб | Плитки СПб",
    description: "Плитка Eletto в Санкт-Петербурге: современные коллекции, большой выбор на складе в СПб. Оперативная доставка по СПб и ЛО.",
  ...
  "pieza-rosa": {
    ...
    description: "Pieza ROSA в Санкт-Петербурге: широкий ассортимент плитки и керамогранита. склад в СПб, доставка по СПб.",
    ...
    advantages: ["Широкий ассортимент", "Доступные цены", "Склад в СПб", "Доставка от 1 дня"],
  },
}
