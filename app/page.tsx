...
export const metadata: Metadata = {
  ...
  description: "Огромный выбор керамической плитки и керамогранита в Санкт-Петербурге. Ведущие мировые бренды. Склад в Янино, доставка от 1 дня. Низкие цены, фото в интерьере.",
  alternates: {
  ...
  mainEntity: [
    {
    ...
    },
      {
        ...
        acceptedAnswer: {
          "@type": "Answer",
          text: "Наш складской терминал расположен в п. Янино-1, Ленинградская область (рядом с КАД). Это удобная точка отгрузки для жителей Санкт-Петербурга и всей области. Режим работы: Пн–Пт 10:00–16:45.",
        },
      },
    {
      "@type": "Question",
