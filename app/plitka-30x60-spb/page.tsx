      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({{
            ...
            {
              "@type": "Question",
              name: "Где купить плитку 30x60 в СПб?",
              acceptedAnswer: { "@type": "Answer", text: "Плитка 30x60 Cersanit в наличии на складе в Янино. Самовывоз бесплатно, доставка по Санкт-Петербургу от 1 рабочего дня. Звоните: +7 (905) 205-09-00." },
            },
            {
              "@type": "Question",
              name: "Куда лучше класть плитку 30x60?",
              acceptedAnswer: { "@type": "Answer", text: "Формат 30x60 универсален: подходит для стен ванной и кухни, коридоров, жилых помещений. Для пола выбирайте плитку с маркировкой PEI 3 и выше." },
            },
            {
              "@type": "Question",
              name: "Сколько плитки 30x60 нужно на комнату?",
              acceptedAnswer: { "@type": "Answer", text: "Разделите площадь на 0.18 (площадь одной плитки) и добавьте 10% запаса на порезку. Наши менеджеры сделают расчёт бесплатно по вашим размерам." },
            }
            ],
          }}),
        }}
