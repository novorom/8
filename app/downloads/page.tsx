...
export const metadata: Metadata = {
  ...
  description: "Бесплатные материалы Cersanit: сертификаты качества, инструкции по укладке, программа 3D-визуализации Ceramic 3D Web. Магазин плитки в Санкт-Петербурге.",
