...
const faq = [
  ...
  { question: "Можно ли приехать без предварительного заказа?", answer: "Да, вы можете приехать в шоурум без предварительной договорённости. Режим работы шоурума: ежедневно 10:00-18:00. Для самовывоза со склада лучше позвонить заранее, чтобы мы подготовили ваш заказ." },
  ...
  { question: "Можно ли посмотреть плитку вживую перед покупкой?", answer: "Да, в нашем шоуруме в Янино вы можете увидеть образцы большинства коллекций. Режим работы: ежедневно 10:00-18:00. Рекомендуем звонить заранее, чтобы мы подготовили интересующие вас образцы." },
]
