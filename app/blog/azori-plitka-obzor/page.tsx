        ...
        <div className="flex flex-col gap-8 text-foreground/80">
          {[
            ...
            },
            {
              ...
              text: "Весь ассортимент Азори из нашего каталога находится на складе в Янино-1 (Ленинградская область).  Самовывоз бесплатный, загружаем в транспорт сами. Доставка по Санкт-Петербургу и ЛО 1–2 рабочих дня. Помогаем рассчитать количество с учётом 10% запаса на подрезку.",
            },
          ].map((item) => (
