...
export const metadata: Metadata = {
  ...
  description: "Обзор коллекций плитки Азори: РИВЕР, ПАТАГОНИЯ, САЛЬВАДОР и другие. Купить Азори в Санкт-Петербурге со склада в СПб. 1000+ позиций в наличии.",
      ...
      <article className="mx-auto max-w-3xl px-4 py-12 lg:py-16">
        <header className="mb-10">
          ...
          <p className="text-lg text-muted-foreground leading-relaxed">
            ...
            Более 1000 позиций в наличии на складе Плитки СПб в СПб.
          </p>
        </header>
        ...
        <div className="flex flex-col gap-8 text-foreground/80">
          {[
            ...
            },
            {
              ...
              text: "Весь ассортимент Азори из нашего каталога находится на складе в СПб (Ленинградская область).  Самовывоз бесплатный, загружаем в транспорт сами. Доставка по Санкт-Петербургу и ЛО 1–2 рабочих дня. Помогаем рассчитать количество с учётом 10% запаса на подрезку.",
            },
          ].map((item) => (
          ...
          <div className="bg-primary/5 border border-primary/20 rounded-2xl p-6 text-center">
            <p className="font-semibold text-foreground mb-2">1000+ позиций Азори на складе в СПб</p>
