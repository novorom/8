...
const articles = [
  ...
  { href: "/blog/nefrit-keramika-obzor", title: "Плитка Нефрит-Керамика: коллекции, цены, где купить в СПб", desc: "Обзор бренда Нефрит-Керамика: форматы, дизайны, цены. Более 900 позиций на складе Плитки СПб в Янино.", date: "2026-03-17", time: "6 мин" },
