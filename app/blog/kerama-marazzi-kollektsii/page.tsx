        ...
        <div className="flex flex-col gap-8 text-foreground/80">
          {[
            ...
            },
            {
              ...
              text: "Магазин Плитки СПб — склад в Янино-1 (Ленинградская область, 15–20 минут от КАД по Мурманскому шоссе). В наличии более 400 позиций Kerama Marazzi. Самовывоз бесплатный, доставка по СПб и ЛО от 1 рабочего дня. Менеджеры помогут подобрать коллекцию и рассчитать нужное количество с учётом подрезки.",
            },
          ].map((item) => (
