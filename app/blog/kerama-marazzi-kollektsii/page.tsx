...
export const metadata: Metadata = {
  ...
  description: "Обзор лучших коллекций Kerama Marazzi: керамогранит, настенная плитка, мозаика. Где купить в Санкт-Петербурге со склада в СПб. Цены и характеристики.",
      ...
      <article className="mx-auto max-w-3xl px-4 py-12 lg:py-16">
        <header className="mb-10">
          ...
          <p className="text-lg text-muted-foreground leading-relaxed">
            ...
            Разбираем самые популярные коллекции, которые есть на складе в СПб.
          </p>
        </header>
        ...
        <div className="flex flex-col gap-8 text-foreground/80">
          {[
            ...
            },
            {
              ...
              text: "Магазин Плитки СПб — склад в СПб (Ленинградская область, 15–20 минут от КАД по Мурманскому шоссе). В наличии более 400 позиций Kerama Marazzi. Самовывоз бесплатный, доставка по СПб и ЛО от 1 рабочего дня. Менеджеры помогут подобрать коллекцию и рассчитать нужное количество с учётом подрезки.",
            },
          ].map((item) => (
          ...
          <div className="bg-primary/5 border border-primary/20 rounded-2xl p-6 text-center">
            ...
            <p className="text-muted-foreground text-sm mb-4">СПб, Ленинградская область · Самовывоз и доставка</p>
            <Link
