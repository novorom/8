    ...
    <div className="min-h-screen bg-background"
      ...
      <article className="mx-auto max-w-4xl px-4 py-10">
        ...
        <div className="prose prose-lg max-w-none mb-12">
          ...
          <p>
            Современный керамогранит Cersanit — это не просто практичный материал, но и красивая отделка для вашего балкона или террасы. Коллекция включает десятки вариантов цветов и фактур: от классического серого и чёрного до тёплых бежевых и коричневых тонов, имитирующих натуральный камень или дерево.
          </p>
          <p>
            Вы можете подобрать плитку, которая идеально впишется в общий стиль вашего дома и сада. Разнообразные размеры, от маленьких мозаик до крупного формата, позволяют создавать разные паттерны и композиции. Официальный дилер Cersanit в Санкт-Петербурге на Янино предоставляет консультации по подбору оптимального варианта для вашего проекта.
          </p>
        ...
        <div className="border-t pt-8 mt-12">
          ...
          <p className="mb-4">
            Керамогранит Cersanit — это оптимальный выбор для отделки балконов и террас в Санкт-Петербурге. Он морозостоек, нескользкий, красивый и практичный. Благодаря своим свойствам, эта плитка будет служить вам верой и правдой многие годы, несмотря на суровый климат северо-запада России.
          </p>
          <p>
            Посетите наш магазин на Янино или свяжитесь с нашей командой, чтобы выбрать идеальный керамогранит для вашего проекта. Мы — официальный дилер Cersanit в Санкт-Петербурге, и мы готовы помочь вам найти решение, которое будет идеально сочетать качество, безопасность и красоту.
          </p>
        </div>
