  ...
  const reviewsSchema = {
    ...
    review: [
      ...
      },
      {
        ...
        reviewBody: "Хорошая компания, надежный поставщик Cersanit. Взял керамогранит 60x60 для ремонта офиса. Плитка качественная, укладчики остались довольны. Единственное — склад работает до 16:45, пришлось подстраиваться.",
      },
    ],
  }
