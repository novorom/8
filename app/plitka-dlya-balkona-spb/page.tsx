...
export default function PlitkaBalkon() {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: `{"@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"Главная","item":"https://plitki-spb.ru"},{"@type":"ListItem","position":2,"name":"Плитка для балкона","item":"https://plitki-spb.ru/plitka-dlya-balkona-spb"}]}` }} />
